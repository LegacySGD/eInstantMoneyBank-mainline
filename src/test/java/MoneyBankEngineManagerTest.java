...
public class MoneyBankEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MoneyBankEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MoneyBankIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MoneyBankIW/InitOutcome.xml").getDocumentElement();
